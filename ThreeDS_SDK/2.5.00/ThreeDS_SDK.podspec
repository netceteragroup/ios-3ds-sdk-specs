...
Pod::Spec.new do |s|
  ...
  s.swift_version = '5'
  s.source       = { :http => "https://nexus.extranet.netcetera.biz/nexus/service/rest/repository/browse/public-repository-maven/com/netcetera/nca-341-2/3ds-sdk/ios/release/#{s.version}/ThreeDS_SDK.zip" }
